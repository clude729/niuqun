...
public class Friend extends UserInfo
{
    ...
    public Friend(String userId, String name, Uri portraitUri, String displayName, String region, String phoneNumber,
        String status, Long timestamp, String nameSpelling, String displayNameSpelling, String letters)
    {
        super(userId, name, portraitUri);
    ...
    public Friend(String userId, String name, Uri portraitUri, String displayName, String region, String phoneNumber,
        String status, Long timestamp, String nameSpelling, String displayNameSpelling)
    {
        super(userId, name, portraitUri);
        this.displayName = displayName;
        this.region = region;
