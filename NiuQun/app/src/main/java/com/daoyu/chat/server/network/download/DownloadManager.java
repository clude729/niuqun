...
package com.daoyu.chat.server.network.download;
...
import com.daoyu.chat.server.network.http.AsyncHttpClient;
import com.daoyu.chat.server.network.http.AsyncHttpResponseHandler;
import com.daoyu.chat.server.network.http.BreakpointHttpResponseHandler;
