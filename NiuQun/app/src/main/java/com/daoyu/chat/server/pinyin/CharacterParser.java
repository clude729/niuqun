package com.daoyu.chat.server.pinyin;
...
public class CharacterParser
{
    ...
    public static String[] pystr = new String[] {"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei",
        "ben", "beng", "bi", "bian", "biao", "bie", "bin", "bing", "bo", "bu", "ca", "cai", "can", "cang", "cao", "ce",
        "ceng", "cha", "chai", "chan", "chang", "chao", "che", "chen", "cheng", "chi", "chong", "chou", "chu", "chuai",
        "chuan", "chuang", "chui", "chun", "chuo", "ci", "cong", "cou", "cu", "cuan", "cui", "cun", "cuo", "da", "dai",
        ...
        "huan", "huang", "hui", "hun", "huo", "ji", "jia", "jian", "jiang", "jiao", "jie", "jin", "jing", "jiong",
        "jiu", "ju", "juan", "jue", "jun", "ka", "kai", "kan", "kang", "kao", "ke", "ken", "keng", "kong", "kou", "ku",
        "kua", "kuai", "kuan", "kuang", "kui", "kun", "kuo", "la", "lai", "lan", "lang", "lao", "le", "lei", "leng",
        "li", "lia", "lian", "liang", "liao", "lie", "lin", "ling", "liu", "long", "lou", "lu", "lv", "luan", "lue",
        "lun", "luo", "ma", "mai", "man", "mang", "mao", "me", "mei", "men", "meng", "mi", "mian", "miao", "mie", "min",
        "ming", "miu", "mo", "mou", "mu", "na", "nai", "nan", "nang", "nao", "ne", "nei", "nen", "neng", "ni", "nian",
        "niang", "niao", "nie", "nin", "ning", "niu", "nong", "nu", "nv", "nuan", "nue", "nuo", "o", "ou", "pa", "pai",
        "pan", "pang", "pao", "pei", "pen", "peng", "pi", "pian", "piao", "pie", "pin", "ping", "po", "pu", "qi", "qia",
        "qian", "qiang", "qiao", "qie", "qin", "qing", "qiong", "qiu", "qu", "quan", "que", "qun", "ran", "rang", "rao",
        ...
        "zao", "ze", "zei", "zen", "zeng", "zha", "zhai", "zhan", "zhang", "zhao", "zhe", "zhen", "zheng", "zhi",
    ...
    public SpannableStringBuilder getColored(String filterStr, String name)
    {
        try
        {
            ...
            if (lowerCaseName.contains(lowerCaseFilterStr))
            {
                ...
                spannableStringBuilder.setSpan(new ForegroundColorSpan(Color.parseColor("#0099ff")), index,
                    index + filterStr.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
            ...
            else if (lowerCaseNameSpelling.startsWith(lowerCaseFilterStr))
            {
                ...
                spannableStringBuilder.setSpan(new ForegroundColorSpan(Color.parseColor("#0099ff")), 0, showCount,
    ...
    private SpannableStringBuilder getOmitColored(String filterStr, String content, int type)
    {
        ...
        if (lowerCaseText.contains(lowerCaseFilterStr))
        {
            ...
            if (length <= 12)
            {
                ...
                spannableStringBuilder.setSpan(new ForegroundColorSpan(Color.parseColor("#0099ff")), firstIndex,
                    firstIndex + filterStr.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
    ...
    public UserInfo generateUserInfoFromFriend(Friend friend)
    {
        if (friend != null)
        {
            UserInfo userInfo = new UserInfo(friend.getUserId(), friend.getName(), friend.getPortraitUri());
            return userInfo;
        }
