package com.daoyu.chat.ui.adapter;
...
public class NewFriendListAdapter extends BaseAdapters
{
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (bean != null && bean.getUser() != null)
        {
            ...
            portraitUri = SealUserInfoManager.getInstance().getPortraitUri(
                new UserInfo(userEntity.getId(), userEntity.getNickname(), Uri.parse(userEntity.getPortraitUri())));
        }
        ...
        switch (Integer.getInteger(bean.getStatus(), 11))
        {
            ...
            case 1: // 已是好友
                ...
                break;
            case 3: // 已是好友
                holder.mState.setText(R.string.refused);
                holder.mState.setBackgroundDrawable(null);
                break;
            case 4: // 删除了好友关系
    ...
    /**
     * displayName : message : 手机号:18622222222昵称:的用户请求添加你为好友 status : 11 updatedAt : 2016-01-07T06:22:55.000Z user :
     * {"id":"i3gRfA1ml","nickname":"nihaoa","portraitUri":""}
     */
