...
import com.daoyu.chat.model.SealCSEvaluateItem;
...
public class BottomEvaluateDialog extends Dialog
{
    ...
    private void setProblemTitle(boolean isTagMust)
    {
        ...
        {
            problems_title
                .setText(title + "(" + mContext.getResources().getString(R.string.cs_evaluate_select_must) + ")");
        }
        else
        {
    ...
    private void initSubmitView()
    {
        ...
        tv_submit.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(mContext, mContext.getResources().getString(R.string.cs_evaluate_tag_must),
                        Toast.LENGTH_SHORT).show();
                    return;
                }
                else if (isInputMust && TextUtils.isEmpty(editTextSuggestion.getText().toString()))
                {
                    Toast.makeText(mContext, mContext.getResources().getString(R.string.cs_evaluate_input_must),
                        Toast.LENGTH_SHORT).show();
                    return;
                }
                if (onEvaluateDialogBehaviorListener != null)
                {
                    onEvaluateDialogBehaviorListener.onSubmit(mStars, tablets, resolveStatus,
                        editTextSuggestion.getText().toString());
                }
            }
        });
    }
    ...
    {
        void onSubmit(int source, String tablets, CustomServiceConfig.CSEvaSolveStatus resolveStatus,
            String suggestion);
