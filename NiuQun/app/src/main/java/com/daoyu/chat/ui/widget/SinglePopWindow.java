...
/**
 * Created by AMing on 16/8/1. Company RongCloud
 */
public class SinglePopWindow extends PopupWindow
{
    ...
    public SinglePopWindow(final Activity context, final Friend friend,
        final RongIMClient.BlacklistStatus blacklistStatus)
    {
        ...
        blacklistStatusRL.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    PromptPopupDialog
                        .newInstance(context, context.getString(R.string.join_the_blacklist),
                            context.getString(R.string.des_add_friend_to_black_list))
                        .setPromptButtonClickedListener(new PromptPopupDialog.OnPromptButtonClickedListener()
                        {
                            @Override
                            public void onPositiveButtonClicked()
                            {
                                RongIM.getInstance().addToBlacklist(friend.getUserId(),
                                    new RongIMClient.OperationCallback()
                                    {
                                        ...
                                        public void onSuccess()
                                        {
                                            ...
                                            {
                                                @Override
                                                public Object doInBackground(int requestCode, String parameter)
                                                ...
                                                public void onSuccess(int requestCode, Object result)
                                                {
                                                    SealUserInfoManager.getInstance()
                                                        .addBlackList(new BlackList(friend.getUserId(), null, null));
